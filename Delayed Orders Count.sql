CREATE TABLE order_details 
	(order_id INT, del_partner VARCHAR(255), predicted_time TIMESTAMP, delivery_time TIMESTAMP); 

INSERT INTO order_details (order_id, del_partner, predicted_time, delivery_time) 
VALUES (11, 'Partner C', '2024-02-29 11:30:00', '2024-02-29 12:00:00'), 
...
/*
Count the delayed orders for each delivery partner based on predicted and actual delivery times.
*/

SELECT DEL_PARTNER,
       COUNT(*) AS NO_OF_DELAYED_ORDERS
FROM ORDER_DETAILS
